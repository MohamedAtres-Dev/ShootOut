...
public class SwipeManager : MonoBehaviour
{
    ...
    public static float swipeDirectionX;

    private float tempSwipeDirX;
    ...
    private void DetectAndTriggerSwipeForTouchInput()
    {
        ...
        if (Input.touches.Length > 0)
        {
            ...
            if (touch.phase == TouchPhase.Began)
            {
                ...
                //Add Another use of swiping
                tempPosX = touch.position.x;
            }
            ...
            if (touch.phase == TouchPhase.Moved || touch.phase == TouchPhase.Stationary)
            {
                ...
                //Modified
                swipeDirectionX = touch.position.x - tempPosX + tempSwipeDirX;
    ...
    private void DetectAndTriggerSwipeForMouseInput()
    {
        ...
        if (Input.GetMouseButton(0))
        {
            ...
            //Modified
            swipeDirectionX = (Input.mousePosition.x - tempPosX) * 10 + tempSwipeDirX;
        }
